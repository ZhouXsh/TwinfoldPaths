...
const specs = [
  ...
  { id:'level-026', chapter:3, order:26, title:'旋转象限', mapping:'ROTATE_CW', axis:'R', laneLength:4, lanes:3, branches:3, features:[{type:'oneWay',ratio:.38},{type:'pauseTile',ratio:.53},{type:'fragile',ratio:.7}], tags:['M4','M5','M7','large-map'], hint:'橙球轨迹是蓝球轨迹的顺时针旋转；把路线当成两个象限来读。', minPar:13 },
  ...
  { id:'level-029', chapter:3, order:29, title:'回路封痕', mapping:'H_MIRROR', axis:'H', laneLength:5, lanes:4, branches:4, features:[{type:'fragile',ratio:.28},{type:'pauseTile',ratio:.49},{type:'fragile',ratio:.61},{type:'pulse',switchRatio:.38,doorRatio:.82}], tags:['M7','M8','large-map'], hint:'两段脆弱路封住退路，脉冲门要求你在深入前建立同步。', minPar:22 },
  ...
  { id:'level-048', chapter:5, order:48, title:'门阵节拍', mapping:'H_MIRROR', axis:'H', laneLength:5, lanes:4, branches:5, features:[{type:'plateDoor',ratio:.3},{type:'pauseTile',ratio:.45},{type:'phaseDoor',ratio:.58,phase:'EVEN'},{type:'colorDoor',ratio:.78}], tags:['M1','M2','M9','phase','large-map'], hint:'压板门、相位门和专属门连续出现，别只盯着空间位置，还要数回合。', minPar:22 },
